        ...
        serviceProvider)
        {
            ...
            <DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                new IdentityRole
                {
                    ...
                    NormalizedName = "UnregisteredUser".ToUpper()
                }
...

                {
                    ...
                    EmailConfirmed = true,
                    NormalizedEmail = "REGISTEREDUSER@TEST.COM",
                    Email = "registereduser@test.com",
                    NormalizedUserName = "REGISTEREDUSER@TEST.COM",
                    PasswordHash = hasher.HashPassword(null,"RegUser1!")
                },
...

                {
                    ...
                    // primary key
                    UserName = "unregistereduser@test.com",
                    EmailConfirmed = true,
                    NormalizedEmail = "UNREGISTEREDUSER@TEST.COM",
                    Email = "unregistereduser@test.com",
                    NormalizedUserName = "UNREGISTEREDUSER@TEST.COM",
                    PasswordHash = hasher.HashPassword(null, "UnRegUser1!")
                }
    );
